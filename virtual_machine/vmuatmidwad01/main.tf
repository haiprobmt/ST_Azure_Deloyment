resource "azurerm_subnet" "subnet_uat_id_01" {
  name                 = "snet-lta-bmms-uat-id-01"
  resource_group_name  = var.resource_group_name
  virtual_network_name = var.vnet_name
  address_prefixes     = var.uat_id_01_cidr
}
...
resource "azurerm_network_interface" "nic" {
  ...
  ip_configuration {
    name                          = "internal"
    subnet_id                     = azurerm_subnet.subnet_uat_id_01.id
