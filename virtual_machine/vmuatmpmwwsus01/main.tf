resource "azurerm_subnet" "subnet_uat_pm_01" {
  name = "snet-lta-bmms-uat-pm-01"
  resource_group_name = var.resource_group_name
  virtual_network_name = var.vnet_name
  address_prefixes = var.uat_pm_01_cidr
}
...
resource "azurerm_network_interface" "nic" {
  ...
  ip_configuration {
    name                          = "internal"
    subnet_id                     = azurerm_subnet.subnet_uat_pm_01.id
