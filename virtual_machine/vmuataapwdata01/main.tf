...
resource "azurerm_network_interface" "nic" {
  ...
  ip_configuration {
    name                          = "internal"
    subnet_id                     = var.subnet_uat_ac_03
...
#   settings = jsonencode({
#     "commandToExecute" = "powershell -ExecutionPolicy Unrestricted -File ./${path.module}/combined_script.ps1"
#   })

#   protected_settings = jsonencode({
#     "script" = base64encode(file("./${path.module}/combined_script.ps1"))
#   })
