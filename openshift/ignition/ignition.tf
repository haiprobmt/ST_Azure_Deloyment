...
locals {
  ...
  openshift_installer_url = "${var.openshift_installer_url}/${var.openshift_version}/openshift-install-linux.tar.gz"
  openshift_installer_client_url = "${var.openshift_installer_url}/${var.openshift_version}/openshift-client-linux.tar.gz"
...
resource "null_resource" "download_binaries" {
  provisioner "local-exec" {
    ...
    command = templatefile("${path.module}/scripts/download.sh.tmpl", {
      ...
      installer_client_url = local.openshift_installer_client_url
